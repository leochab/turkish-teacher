...
If `progress/learner.md` is unfilled (fields still contain placeholder text like `[your name]`), invoke the `/setup` command before proceeding.
...
| `/setup` | Run (or re-run) the onboarding flow to set or update the learner profile |
